...
// Secret admin access: click © 3 times
...
const handleCopyrightClick = () => {
  ...
  if (clickCount.value >= 3) {
    ...
    clickTimer = setTimeout(() => { clickCount.value = 0; }, 1500);
  }
};
</script>
  ...
  <footer class="footer">
    ...
    <div class="footer-content">
      ...
      <div class="footer-credits">
        ...
        <p><span class="copyright-trigger" @click="handleCopyrightClick">©</span> {{ new Date().getFullYear() }} Ritesh Veer</p>
      </div>
    </div>
  </footer>
</template>
