...
.blog-post-error button { margin-top: 16px; background: #FF6B00; border: none; color: #fff; padding: 10px 20px; border-radius: 999px; cursor: pointer; font-weight: 700; }

.blog-post-header { display: flex; align-items: center; gap: 16px; margin-bottom: 32px; }
.blog-post-back {
  background: #FF6B00; border: none; color: #fff; width: 40px; height: 40px; border-radius: 50%;
  display: flex; align-items: center; justify-content: center; cursor: pointer; flex-shrink: 0;
}
.blog-post-meta { display: flex; align-items: center; gap: 12px; flex-wrap: wrap; }
.blog-post-date { font-size: 0.8rem; color: #888; }
.blog-post-tags { display: flex; gap: 6px; flex-wrap: wrap; }
.blog-post-tag { font-family: "Space Mono", monospace; font-size: 0.7rem; padding: 3px 10px; border-radius: 20px; border: 1px solid #FF6B00; color: #FF6B00; background: rgba(255,107,0,0.05); }
...
.bp-paragraph { margin-bottom: 20px; color: #333; :deep(a) { color: #FF6B00; text-decoration: underline; } :deep(code) { background: #E8E0D0; padding: 2px 6px; border-radius: 4px; font-size: 0.85em; color: #FF6B00; font-family: "Space Mono", monospace; } }
.bp-h2 { font-family: "Poppins", sans-serif; font-weight: 800; font-size: 1.8rem; margin: 40px 0 16px; color: #1A1A1A; }
.bp-h3 { font-family: "Poppins", sans-serif; font-weight: 700; font-size: 1.3rem; margin: 32px 0 12px; color: #1A1A1A; }
.bp-h4 { font-family: "Poppins", sans-serif; font-weight: 600; font-size: 1.1rem; margin: 24px 0 10px; color: #333; }

.bp-list { margin: 0 0 20px 24px; color: #333; li { margin-bottom: 8px; } }
.bp-list-ordered { list-style-type: decimal; }

.bp-code {
  background: #1A1A1A; color: #E0E0E0; border: none; border-radius: 10px;
